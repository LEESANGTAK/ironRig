...
class GlobalMaster(Master):
    ...
    def _createGroups(self):
        ...
        self._spaceSwtichGrp = cmds.createNode('transform', n='spaceSwitches_grp'.format(self.fullName))
        self._spaceSwtichGrp.hide()
        self._mastersGrp = cmds.createNode('transform', n='{}masters'.format(self.fullName))
