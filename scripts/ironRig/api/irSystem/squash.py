...
class Squash(System):
    ...
    def _buildSystems(self):
        ffdNodes = cmds.lattice(self._vertices, dv=(5, 5, 5), oc=True, n='{}ffd'.format(self.shortName))
        self._ffd = ffdNodes[1]
        ffdBottomYPos = cmds.xform('{}.pt[2][0][2]'.format(self._ffd), q=True, t=True, ws=True)[1]

        squash, self._squashHandle = cmds.nonLinear(self._ffd, type='squash', n='{}squash'.format(self.shortName))
        ...
        sideBend, self._sideBendHandle = cmds.nonLinear(self._ffd, type='bend', n='{}side_bend'.format(self.shortName))
        ...
        forwardBend, self._forwardBendHandle = cmds.nonLinear(self._ffd, type='bend', n='{}forward_bend'.format(self.shortName))
    ...
    def _buildControls(self):
        ...
        squashScalerMult = cmds.createNode('multDoubleLinear', n='{}squash_mult'.format(self.shortName))
